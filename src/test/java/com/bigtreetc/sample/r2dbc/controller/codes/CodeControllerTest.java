...
class CodeControllerTest extends BaseTestContainerTest {
  ...
  @Test
  @DisplayName("権限を持つロールで、コードマスタを検索できること")
  void test1() throws Exception {
    val token = jwtRepository.createAccessToken("test", List.of("code:read")).block();
    assertThat(token).isNotNull();

    webClient
        .get()
        .uri("/api/system/codes")
  ...
  @Test
  @DisplayName("権限を持たないロールでは、コードマスタ検索がエラーになること")
