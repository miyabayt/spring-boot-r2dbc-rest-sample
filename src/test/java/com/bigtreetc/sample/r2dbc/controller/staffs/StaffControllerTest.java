...
class StaffControllerTest extends BaseTestContainerTest {
  ...
  @Test
  @DisplayName("権限を持つロールで、担当者マスタを検索できること")
  void test1() throws Exception {
    val token = jwtRepository.createAccessToken("test", List.of("staff:read")).block();
    assertThat(token).isNotNull();

    webClient
        .get()
        .uri("/api/system/staffs")
  ...
  @Test
  @DisplayName("権限を持たないロールでは、担当者マスタ検索がエラーになること")
